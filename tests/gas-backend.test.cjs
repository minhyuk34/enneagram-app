...
assert.match(sentEmails[0].htmlBody, /1w9/);
assert.match(sentEmails[0].htmlBody, /이상주의자/);
assert.match(sentEmails[0].htmlBody, /8w7/);
assert.match(sentEmails[0].htmlBody, /독립자/);
assert.match(sentEmails[0].htmlBody, /나의 날개/);
assert.match(sentEmails[0].htmlBody, /최종 유형/);
assert.match(sentEmails[0].htmlBody, /min-width:1080px/);
assert.match(sentEmails[0].htmlBody, /bgcolor="#171310"/);
assert.match(sentEmails[0].htmlBody, /border-left:5px solid #9f2027/);
assert.doesNotMatch(sentEmails[0].htmlBody, /class="er-/);
